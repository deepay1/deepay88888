        ...
        <div class="col-12">
            <div class="alert alert--info d-flex" role="alert">
                ...
                <div class="alert__content">
                    <p class="fw-600">
                        @lang("The API provider's currency code must match the system currency; otherwise, automatic product fetching and the Gift Card module may not function correctly.")
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <button type="button" class="my-5 btn btn--sm btn-outline--primary d-none confirmationBtn"
                data-question="@lang('Are you sure to add this countries?')" data-action="{{ route('admin.gift.card.countries.save') }}"> <i
...
@push('breadcrumb-plugins')
    <button type="button" class="btn btn-sm btn--success  confirmationBtn disabled" disabled
        data-question="@lang('Are You sure to add these selected countries?')" data-action="{{ route('admin.gift.card.countries.save') }}">
        <i class="lab la-telegram-plane me-1"></i> @lang('Add Selected Country')
    </button>

    <x-back_btn route="{{ route('admin.gift.card.countries') }}" />
@endpush
