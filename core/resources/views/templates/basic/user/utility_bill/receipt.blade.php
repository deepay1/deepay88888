        ...
        <div class="card custom--card">
            ...
            <div class="card-body">
                <div class="payment-info">
                    ...
                    <div class="payment-info-item">
                        <span class="title">@lang('Reference')</span>
                        <span class="desc">{{ __(@$utilityBill->reference) }}</span>
                    </div>
                    <div class="payment-info-item">
                    ...
                    <div class="payment-info-item">
                        ...
                        <span class="desc">{{ showAmount($utilityBill->amount) }}
                            ({{ getAmount($utilityBill->amount / $utilityBill->rate) }}
                            {{ @$utilityBill->company->currency_code }}) </span>
                    </div>
                    <div class="payment-info-item">
                        <span class="title">@lang('Charge')</span>
                        <span class="desc">{{ showAmount($utilityBill->charge) }} ({{ getAmount($utilityBill->charge / $utilityBill->rate) }}
                            {{ @$utilityBill->company->currency_code }}) </span>
                    </div>
                    <div class="payment-info-item total">
                        <span class="title">@lang('Total')</span>
                        <span class="desc">{{ showAmount($utilityBill->total) }}
                            ({{ getAmount($utilityBill->total / $utilityBill->rate) }}
                            {{ @$utilityBill->company->currency_code }}) </span>
                    </div>
                    <div class="payment-info-item total">
                        <span class="title">@lang('Total')</span>
                        <span class="desc">  {{ $utilityBill->token ?? 'N/A' }} </span>
                    </div>
                    <div class="payment-info-item total">
